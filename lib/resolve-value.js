...
var resolveValue = function(decl, map, /*optional*/ignorePseudoScope, /*optional*/preserveUndefinedVariables) {
	...
	while ((matchingVarDecl = balancedVar(resultantValue))) {
		...
		var shouldPreserveUndefinedVariable = isResultantValueUndefined && preserveUndefinedVariables;

		replaceValue = shouldPreserveUndefinedVariable
		...
		if (shouldPreserveUndefinedVariable) {
			break;
		}
	}
